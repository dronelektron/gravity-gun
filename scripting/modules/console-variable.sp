...
void Variable_Create() {
    g_pluginEnabled = CreateConVar("sm_gravitygun_enable", "1", "Enable (1) or disable (0) gravity gun");
    g_defaultDistanceEnabled = CreateConVar("sm_gravitygun_default_distance", "1", "Enable (1) or disable (0) default capture distance");
    g_defaultDistance = CreateConVar("sm_gravitygun_distance", "128.0", "Default capture distance");
